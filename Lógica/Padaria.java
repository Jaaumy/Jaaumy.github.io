...
public class Padaria {
    public static void main(String[] args) {
        ...
        //Na classe padaria separei por categoria: pâes, bolos e salgados
        ...
        if (tipo == 1){
            ...
            //Exibir lista de bolos e doces
        }else if (tipo == 2){
            System.out.println();
            System.out.println("=== Bolo e Doces ===");
